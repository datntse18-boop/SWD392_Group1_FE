...
/**
 * Send a message to a seller (FR-11)
 * @param {Object} messageData - { senderId, receiverId, bikeId, content }
 */
...
/**
 * Submit a review for a completed order (FR-12)
 * @param {Object} reviewData - { orderId, buyerId, sellerId, rating, comment }
 */
