    ...
    <div className="container mx-auto px-4 lg:px-8 py-8 w-full max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          {bike.imageUrls && bike.imageUrls.length > 1 && (
            <div className="grid grid-cols-4 gap-2">
              {bike.imageUrls.map((url, index) => (
                <div
                  key={index}
                  className="aspect-square bg-gray-100 rounded-lg overflow-hidden border border-gray-200 cursor-pointer hover:opacity-80 transition-opacity"
                >
                  <img
                    src={url}
        ...
        <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium text-gray-900">
                  {bike.sellerName || "Anonymous Seller"}
                </p>
          ...
          {/* FR-12: Submit Review */}
          <ReviewForm sellerId={bike.sellerId} sellerName={bike.sellerName} />
        </div>
      </div>
    </div>
  );
